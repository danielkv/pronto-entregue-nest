...
@Injectable()
export class CompanyLocationFilter implements IFilter<Company, CompanyExtraFilterDTO> {
    apply(query: SelectQueryBuilder<Company>, filter?: CompanyExtraFilterDTO): SelectQueryBuilder<Company> {
