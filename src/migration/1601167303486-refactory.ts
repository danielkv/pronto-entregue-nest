...
export class refactory1601167303486 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `company_payment_methods` DROP FOREIGN KEY `company_payment_methods_ibfk_1`");
        await queryRunner.query("ALTER TABLE `company_payment_methods` DROP FOREIGN KEY `company_payment_methods_ibfk_2`");
        ...
        await queryRunner.query("ALTER TABLE `options_groups` ADD UNIQUE INDEX `IDX_3aecc6d707a2e8787b82bbc707` (`maxSelectRestrain`)");
        ...
        await queryRunner.query("ALTER TABLE `credit_balances` ADD UNIQUE INDEX `IDX_7f8103cfe175c66f1e5e8acfe2` (`userId`)");
        ...
        await queryRunner.query("ALTER TABLE `coupons` CHANGE `masterOnly` `masterOnly` tinyint NULL COMMENT 'Se verdadeiro, apenas usuário master consegue alterar' DEFAULT 0");
        await queryRunner.query("ALTER TABLE `coupons` CHANGE `onlyFirstPurchases` `onlyFirstPurchases` tinyint NULL COMMENT 'Se verdadeiro, apenas válido apenas para primeira compra de cada usuário' DEFAULT 0");
        await queryRunner.query("ALTER TABLE `coupons` CHANGE `featured` `featured` tinyint NULL COMMENT 'Se verdadeiro, usuário pode pegar cupom na home do app' DEFAULT 0");
        ...
        await queryRunner.query("ALTER TABLE `coupons` CHANGE `freeDelivery` `freeDelivery` tinyint NOT NULL DEFAULT 0");
        ...
        await queryRunner.query("ALTER TABLE `products` CHANGE `listed` `listed` tinyint NULL COMMENT 'Show the product in product list and search' DEFAULT 1");
        await queryRunner.query("ALTER TABLE `products` CHANGE `scheduleEnabled` `scheduleEnabled` tinyint NULL DEFAULT 0");
        ...
        await queryRunner.query("ALTER TABLE `companies` CHANGE `acceptTakeout` `acceptTakeout` tinyint NOT NULL DEFAULT 1");
        ...
        await queryRunner.query("CREATE UNIQUE INDEX `REL_3aecc6d707a2e8787b82bbc707` ON `options_groups` (`maxSelectRestrain`)");
        ...
        await queryRunner.query("ALTER TABLE `coupon_companies` ADD CONSTRAINT `FK_4b6a4884f5c7291d652bf955398` FOREIGN KEY (`couponId`) REFERENCES `coupons`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION");
        await queryRunner.query("ALTER TABLE `coupon_companies` ADD CONSTRAINT `FK_896186ddfb5aa38f3606492d3a8` FOREIGN KEY (`companyId`) REFERENCES `companies`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION");
        await queryRunner.query("ALTER TABLE `coupon_products` ADD CONSTRAINT `FK_32d7f809acaa65ddcaf7eb22f37` FOREIGN KEY (`couponId`) REFERENCES `coupons`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION");
        await queryRunner.query("ALTER TABLE `coupon_products` ADD CONSTRAINT `FK_d37ece730758316fcc06d20ca3d` FOREIGN KEY (`productId`) REFERENCES `products`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION");
        await queryRunner.query("ALTER TABLE `coupon_users` ADD CONSTRAINT `FK_f0b0ea9f550e1fd439ca459ecb0` FOREIGN KEY (`couponId`) REFERENCES `coupons`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION");
        await queryRunner.query("ALTER TABLE `coupon_users` ADD CONSTRAINT `FK_a79deee063e7500c19cb23c0e95` FOREIGN KEY (`userId`) REFERENCES `users`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION");
        await queryRunner.query("ALTER TABLE `favorite_products` ADD CONSTRAINT `FK_393984c0bf9c461d0171360f737` FOREIGN KEY (`userId`) REFERENCES `users`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION");
        await queryRunner.query("ALTER TABLE `favorite_products` ADD CONSTRAINT `FK_aec1e29e9ebed0d27e185c4896e` FOREIGN KEY (`productId`) REFERENCES `products`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION");
        ...
        await queryRunner.query("ALTER TABLE `user_addresses` ADD CONSTRAINT `FK_fa6da87159415a34ef76d14f729` FOREIGN KEY (`addressId`) REFERENCES `addresses`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION");
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `favorite_products` CHANGE `productId` `productId` int NOT NULL DEFAULT '0'");
        await queryRunner.query("ALTER TABLE `favorite_products` CHANGE `userId` `userId` int NOT NULL DEFAULT '0'");
        await queryRunner.query("ALTER TABLE `companies` CHANGE `published` `published` tinyint(1) NOT NULL DEFAULT '0'");
        await queryRunner.query("ALTER TABLE `companies` CHANGE `active` `active` tinyint(1) NULL DEFAULT '0'");
        await queryRunner.query("ALTER TABLE `companies` CHANGE `acceptTakeout` `acceptTakeout` tinyint(1) NOT NULL DEFAULT '1'");
        ...
        await queryRunner.query("ALTER TABLE `products` CHANGE `scheduleEnabled` `scheduleEnabled` tinyint(1) NULL DEFAULT '0'");
        await queryRunner.query("ALTER TABLE `products` CHANGE `listed` `listed` tinyint(1) NULL COMMENT 'Show the product in product list and search' DEFAULT '1'");
        ...
        await queryRunner.query("ALTER TABLE `payment_methods` CHANGE `active` `active` tinyint(1) NOT NULL DEFAULT '1'");
        ...
        await queryRunner.query("ALTER TABLE `coupons` CHANGE `freeDelivery` `freeDelivery` tinyint(1) NOT NULL DEFAULT '0'");
        ...
        await queryRunner.query("ALTER TABLE `coupons` CHANGE `featured` `featured` tinyint(1) NULL COMMENT 'Se verdadeiro, usuário pode pegar cupom na home do app' DEFAULT '0'");
        await queryRunner.query("ALTER TABLE `coupons` CHANGE `onlyFirstPurchases` `onlyFirstPurchases` tinyint(1) NULL COMMENT 'Se verdadeiro, apenas válido apenas para primeira compra de cada usuário' DEFAULT '0'");
        await queryRunner.query("ALTER TABLE `coupons` CHANGE `masterOnly` `masterOnly` tinyint(1) NULL COMMENT 'Se verdadeiro, apenas usuário master consegue alterar' DEFAULT '0'");
        ...
        await queryRunner.query("ALTER TABLE `options_groups` CHANGE `removed` `removed` tinyint(1) NOT NULL DEFAULT '0'");
        ...
        await queryRunner.query("ALTER TABLE `user_addresses` ADD CONSTRAINT `user_addresses_ibfk_2` FOREIGN KEY (`addressId`) REFERENCES `addresses`(`id`) ON DELETE CASCADE ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `user_addresses` ADD CONSTRAINT `user_addresses_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `users`(`id`) ON DELETE CASCADE ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `favorite_products` ADD CONSTRAINT `favorite_products_ibfk_2` FOREIGN KEY (`productId`) REFERENCES `products`(`id`) ON DELETE CASCADE ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `favorite_products` ADD CONSTRAINT `favorite_products_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `users`(`id`) ON DELETE CASCADE ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `coupon_users` ADD CONSTRAINT `coupon_users_ibfk_2` FOREIGN KEY (`userId`) REFERENCES `users`(`id`) ON DELETE CASCADE ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `coupon_users` ADD CONSTRAINT `coupon_users_ibfk_1` FOREIGN KEY (`couponId`) REFERENCES `coupons`(`id`) ON DELETE CASCADE ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `coupon_products` ADD CONSTRAINT `coupon_products_ibfk_2` FOREIGN KEY (`productId`) REFERENCES `products`(`id`) ON DELETE CASCADE ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `coupon_products` ADD CONSTRAINT `coupon_products_ibfk_1` FOREIGN KEY (`couponId`) REFERENCES `coupons`(`id`) ON DELETE CASCADE ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `coupon_companies` ADD CONSTRAINT `coupon_companies_ibfk_2` FOREIGN KEY (`companyId`) REFERENCES `companies`(`id`) ON DELETE CASCADE ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `coupon_companies` ADD CONSTRAINT `coupon_companies_ibfk_1` FOREIGN KEY (`couponId`) REFERENCES `coupons`(`id`) ON DELETE CASCADE ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `companies` ADD CONSTRAINT `companies_ibfk_2` FOREIGN KEY (`addressId`) REFERENCES `addresses`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `companies` ADD CONSTRAINT `companies_ibfk_1` FOREIGN KEY (`companyTypeId`) REFERENCES `company_types`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `view_areas` ADD CONSTRAINT `view_areas_ibfk_1` FOREIGN KEY (`companyId`) REFERENCES `companies`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `delivery_areas` ADD CONSTRAINT `delivery_areas_ibfk_1` FOREIGN KEY (`companyId`) REFERENCES `companies`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `company_metas` ADD CONSTRAINT `company_metas_ibfk_1` FOREIGN KEY (`companyId`) REFERENCES `companies`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `categories` ADD CONSTRAINT `categories_ibfk_1` FOREIGN KEY (`companyId`) REFERENCES `companies`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `products` ADD CONSTRAINT `products_ibfk_4` FOREIGN KEY (`companyId`) REFERENCES `companies`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `products` ADD CONSTRAINT `products_ibfk_3` FOREIGN KEY (`categoryId`) REFERENCES `categories`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `sales` ADD CONSTRAINT `sales_ibfk_1` FOREIGN KEY (`productId`) REFERENCES `products`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `order_products` ADD CONSTRAINT `order_products_ibfk_3` FOREIGN KEY (`productRelatedId`) REFERENCES `products`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `order_products` ADD CONSTRAINT `order_products_ibfk_2` FOREIGN KEY (`orderId`) REFERENCES `orders`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `order_products` ADD CONSTRAINT `order_products_ibfk_1` FOREIGN KEY (`productId`) REFERENCES `products`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `orders` ADD CONSTRAINT `orders_ibfk_29` FOREIGN KEY (`couponId`) REFERENCES `coupons`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `orders` ADD CONSTRAINT `orders_ibfk_28` FOREIGN KEY (`creditHistoryId`) REFERENCES `credit_history`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `orders` ADD CONSTRAINT `orders_ibfk_27` FOREIGN KEY (`paymentMethodId`) REFERENCES `payment_methods`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `orders` ADD CONSTRAINT `orders_ibfk_26` FOREIGN KEY (`companyId`) REFERENCES `companies`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `orders` ADD CONSTRAINT `orders_ibfk_25` FOREIGN KEY (`userId`) REFERENCES `users`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `company_payment_methods` ADD CONSTRAINT `company_payment_methods_ibfk_2` FOREIGN KEY (`paymentMethodId`) REFERENCES `payment_methods`(`id`) ON DELETE CASCADE ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `company_payment_methods` ADD CONSTRAINT `company_payment_methods_ibfk_1` FOREIGN KEY (`companyId`) REFERENCES `companies`(`id`) ON DELETE CASCADE ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `deliveries` ADD CONSTRAINT `deliveries_ibfk_4` FOREIGN KEY (`deliveryManId`) REFERENCES `users`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `deliveries` ADD CONSTRAINT `deliveries_ibfk_3` FOREIGN KEY (`orderId`) REFERENCES `orders`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `user_metas` ADD CONSTRAINT `user_metas_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `users`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `ratings` ADD CONSTRAINT `ratings_ibfk_3` FOREIGN KEY (`userId`) REFERENCES `users`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `ratings` ADD CONSTRAINT `ratings_ibfk_2` FOREIGN KEY (`orderId`) REFERENCES `orders`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `ratings` ADD CONSTRAINT `ratings_ibfk_1` FOREIGN KEY (`companyId`) REFERENCES `companies`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `credit_history` ADD CONSTRAINT `credit_history_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `users`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `credit_balances` ADD CONSTRAINT `credit_balances_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `users`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `company_users` ADD CONSTRAINT `company_users_ibfk_3` FOREIGN KEY (`roleId`) REFERENCES `roles`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `company_users` ADD CONSTRAINT `company_users_ibfk_2` FOREIGN KEY (`userId`) REFERENCES `users`(`id`) ON DELETE CASCADE ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `company_users` ADD CONSTRAINT `company_users_ibfk_1` FOREIGN KEY (`companyId`) REFERENCES `companies`(`id`) ON DELETE CASCADE ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `order_option_groups` ADD CONSTRAINT `order_option_groups_ibfk_2` FOREIGN KEY (`optionsGroupRelatedId`) REFERENCES `options_groups`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `order_option_groups` ADD CONSTRAINT `order_option_groups_ibfk_1` FOREIGN KEY (`orderProductId`) REFERENCES `order_products`(`id`) ON DELETE CASCADE ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `options_groups` ADD CONSTRAINT `options_groups_ibfk_2` FOREIGN KEY (`maxSelectRestrain`) REFERENCES `options_groups`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `options_groups` ADD CONSTRAINT `options_groups_ibfk_1` FOREIGN KEY (`productId`) REFERENCES `products`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `options` ADD CONSTRAINT `options_ibfk_1` FOREIGN KEY (`optionsGroupId`) REFERENCES `options_groups`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `order_options` ADD CONSTRAINT `order_options_ibfk_2` FOREIGN KEY (`optionRelatedId`) REFERENCES `options`(`id`) ON DELETE SET NULL ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `order_options` ADD CONSTRAINT `order_options_ibfk_1` FOREIGN KEY (`orderOptionsGroupId`) REFERENCES `order_option_groups`(`id`) ON DELETE CASCADE ON UPDATE CASCADE");
    }
